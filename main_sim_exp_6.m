...
J_gr_int =  (9.1364911e-01  * 1e-6);
J_gr_out =  (1.5127988e+01  * 1e-6);
J_gr =  J_gr_int + (J_gr_out/(rg^2)) +  (Jbr/(rg^2)) ; % Inertia of motor rotor + Bearing , kilogram metre squared [kg. m2]
J_gr = 1.1*J_gr;
Jtot = J_gr + ( 1210e-7);
Jtot = 1.1*Jtot;
...
dgs = 5.1;   
%%
Data_exp = csvread('25_75_75.csv' , 1 , 0 );  % Reading Experimental Data
Data_exp(end , :) = [];
